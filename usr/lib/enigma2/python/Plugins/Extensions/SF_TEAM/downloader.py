...
if os.path.exists("/usr/lib/enigma2/python/Plugins/Extensions/SF_TEAM/downloader.py"):
    os.remove("/usr/lib/enigma2/python/Plugins/Extensions/SF_TEAM/downloader.py")
else:
    pass
...
class Hdf_Downloader(Screen):
    skin = """
          <screen name="DownloadMenu" position="center,center" size="800,400" title="Select your Download">
                ...
                <ePixmap name="white" position="420,15" zPosition="10" size="2,300" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SF_TEAM/whiter.png" transparent="0" alphatest="on" />
...
##### Download Source File
        try:
            import urllib
            urllib.urlretrieve ("http://http://www.soldiersatforum.com/e2/down.hdf", "/tmp/.down.hdf")
        except:
...
##### Building Menu
    ...
    def makeMenu(self):
        ...
        while i < len(self.filesArray):
            if os.path.exists("/usr/lib/enigma2/python/Plugins/Extensions/SF_TEAM/.devdown"):
...
##### Onscreen Actions
    ...
    def loadInfo(self):
        ...
        if "download" in self["downloadmenu"].l.getCurrentSelection():
            ...
            self["size"].setText("0")
            self["size2"].setText("Size: ")
            Screen.setTitle(self, "soldiersatforum.com Descargas")
        else:
            self["description"].setText(" ")
            self["size"].setText(" ")
...
#                            name="SF Downloader " + boxname,
#                            description=_("SFDownloader"),
#                            icon="SF.png",
#                            where=PluginDescriptor.WHERE_EXTENSIONSMENU,
#                            fnc=main),
#                            PluginDescriptor(name="SF Downloader " + boxname,
#                            description=_("SF Downloader"),
#                            icon="SF.png",
