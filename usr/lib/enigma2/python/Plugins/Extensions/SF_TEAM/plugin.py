...
print bcolors.OKGREEN + "~~~~~~~ SF_TEAM ~ read box informations ~~~~~~~" + bcolors.ENDC
...
fantastic_pluginversion = "Version 0.1.0 .. SF mod"
fantastic_pluginpath = "/usr/lib/enigma2/python/Plugins/Extensions/SF_TEAM"
fantastic_readme = "/usr/lib/enigma2/python/Plugins/Extensions/SF_TEAM/readme.txt"
splitchar = ":"
...
class Fantastic(Screen):
    skin = """
        <screen position="150,150" size="360,395" title="SF Adonns">
        <widget name="menu" position="10,10" size="340,340" scrollbarMode="showOnDemand" enableWrapAround="1" />
		<ePixmap position="10,335" size="380,57" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/SF_TEAM/banner.png" zPosition="1" alphatest="on" />
    ...
    def __init__(self, session, args = 0):
        ...
        if os.path.exists("/usr/lib/enigma2/python/Plugins/Extensions/SF_TEAM/SF.png") is True:
           mainmenu.append(("SF-Descargas" , "mfschdf"))
    ...
    def FantasticMainMenu(self):
        ...
        if mfselected is not None:
           if mfselected is "mfreadme":
               ...
               title3=_("~~~~~~~~~~~~~~~~~~~~~~~~~")
               title4=_("adapted by www.soldiersatforum.com")
               ...
               try:
					...
					self.session.open(MessageBox, ("There seems to be an Error!\nPlease check if your internet connection is established correctly."), MessageBox.TYPE_INFO, timeout=10).setTitle(_("soldiersatforum.com soporte Error"))
...
class FantasticBoot(Screen):
        skin = """
            <screen position="100,100" size="500,400" title="soldiersatforum.com" >
            </screen>"""
